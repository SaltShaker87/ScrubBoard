...
MARKER_FORMAT = "PrivateCopy.Redacted"
...
class WindowsClipboard(ClipboardBackend):
    ...
    def start(self, on_change: OnChange) -> None:
        ...
        self._thread = threading.Thread(target=self._run, args=(on_change, ready),
                                        name="privatecopy-win-clipboard", daemon=True)
        self._thread.start()
    ...
    def _run(self, on_change: OnChange, ready: threading.Event) -> None:
        ...
        wc.hInstance = hinst
        wc.lpszClassName = "PrivateCopyClipboardListener"
        ...
        hwnd = api.CreateWindowExW(0, wc.lpszClassName, "PrivateCopy", 0, 0, 0, 0, 0,
