...
Installers bundle it at build time; `privatecopy download-model --llama-server`
...
from privatecopy.download import Progress, fetch
from privatecopy.llm.runtime import default_install_dir, server_exe_name
from privatecopy.models.manifest import LLAMA_CPP_ASSETS, LLAMA_CPP_BUILD, LLAMA_CPP_URL
